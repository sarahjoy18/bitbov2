	...
	<div class="tab-content">
		...
		<div class="tab-pane fade" id="nav-pills-tab-2">
			<div class="panel panel-inverse">
				...
				<!-- begin panel-body -->
				<div class="panel-body">
					<?php echo $__env->make('permit_certification_clearance.forms.business_permit_appform', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				...
				<div class="modal-body">
						...
						<form>
							...
							<div id="divBusinessClearance">
								<br>
								<div class="col-md-10" id="divBusinessPermit">
									<h4>The gross receipt sales is more than ₱30,000. Request for Business Clearance <a href="<?php echo e(route('RequestClearance')); ?>">here</a></h4>
...
<script>
	...
	$('#btnRequest').on('click', function(){
		...
		$.ajax({
			url : "<?php echo e(route('BusinessIssuanceRequest')); ?>",
			method : 'POST',
			data : data,
...
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bitbo_installer\www\resources\views/permit_certification_clearance/permit.blade.php ENDPATH**/ ?>
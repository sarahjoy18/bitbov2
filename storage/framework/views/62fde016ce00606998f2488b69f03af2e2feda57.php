					...
					<table id="tbl_business_lst" class="table table-striped table-bordered">
						...
						<tbody>
							...
							<tr class="gradeC" id="<?php echo e($row->BUSINESS_ID); ?>">
								...
								<td><?php echo e($row->BUSINESS_NAME); ?> <br> (<?php echo e($row->BUSINESS_NATURE_NAME); ?>)</td>
		...
		<div class="tab-pane fade " id="nav-pills-tab-3">
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					...
					<?php echo $__env->make('business.form.business_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				</div>
				<!-- end panel-body -->
			</div> 
		</div>		
...
$('#btnSubmitBusinessRegistration').on('click', function(){
	...
	$.ajax({
		url : "<?php echo e(route('CRUDBusinessApplication')); ?>",
		method : 'POST',
		data : data,
	...
	$('#tbl_business_lst').on('click', '#btnRenewOpen', function(){
		...
		$.ajax({
			url : "<?php echo e(route('SpecificBusinessApplication')); ?>",
			method : 'POST',
			data : data,
			success : function(response) {
...
<link href="<?php echo e(asset('assets/plugins/pace/pace.min.js')); ?>"/>
...
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/business/business_registration.blade.php ENDPATH**/ ?>
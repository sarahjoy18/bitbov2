<?php $__env->startSection('title', "Residents' Basic Info"); ?>
...
<script src="<?php echo e(asset('assets/plugins/jquery-smart-wizard/src/js/jquery.smartWizard.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/demo/form-wizards.demo.min.js')); ?>"></script>
...
function validatedate(value,fd) {
    ...
    async function Add(fd) {
     ...
     {
        result = await $.ajax({
            url:"<?php echo e(route('BasicInfoAdd')); ?>",
            type:'post',
   ...
   return splitStr.join(' ');
    ...
    $(document).ready(function(){
        ...
        async function Update(fd) {
           ...
           {
               result = await $.ajax({
                   url:"<?php echo e(route('BasicInfoEdit')); ?>",
                   type:'post',
                   processData:false,
                   contentType:false,
                   cache:false,
...
<script type="text/javascript">
    ...
    $("#resident_table tbody").on('click', '.disableResident', function () {
       ...
       async function Disable(fd) {
         ...
         {
           result = await $.ajax({
               url:"<?php echo e(route('BasicInfoDelete')); ?>",
               type:'post',
               processData:false,
               contentType:false,
               cache:false,
...
$(document).ready(function(){
   ...
   $('#btnExport').on('click', function(){
    ...
    .then((willDelete) => {
        if (willDelete)
        {
            window.location.href = "<?php echo e(route('ResidentsExport')); ?>";
        }
        else
        {
    ...
    else
    {
        ...
        else
        {
            ...
            .then((willDelete) => {
                ...
                {
                    $.ajax({
                        url : "<?php echo e(route('ResidentsImport')); ?>",
                        method : 'POST',
                        processData:false,
                        contentType:false,
                        cache:false,
...
<script type="text/javascript">
  ...
  $('.search_btn').on('click',function() {
            ...
            $.ajax({
               url:  "<?php echo e(route('LoadResidents')); ?>",
               type: 'get',
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <table id="resident_table" class="table table-hover table-striped table-bordered data-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                           <!--  
                            edited by SJ 06162020 - fetched data from sp_resident_info
                            related files - Http/Controllers/ResidentController.php
                                          - Models/TResidentBasicInfo.php 
                            -->
                             <?php $__currentLoopData = $display_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr >
                                <td hidden><?php echo e($Value->RESIDENT_ID); ?></td>
                                <td ><?php echo e($Value->LASTNAME); ?></td>
                                <td ><?php echo e($Value->FIRSTNAME); ?></td>
                                <td ><?php echo e($Value->MIDDLENAME); ?></td>
                                <td ><?php echo e($Value->QUALIFIER); ?></td>
                                <td ><?php echo e($Value->DATE_OF_BIRTH); ?></td>
                                <td ><?php echo e($Value->PLACE_OF_BIRTH); ?></td>
                                <td ><?php echo e($Value->RELATION_TO_HOUSEHOLD_HEAD); ?></td>
                                <td ></td>
                                <td ><?php echo e($Value->ADDRESS_HOUSE_NO); ?></td>
                                <td ><?php echo e($Value->ADDRESS_STREET); ?></td>
                                <td ><?php echo e($Value->ADDRESS_STREET); ?></td>
                                <td ><?php echo e($Value->FIRSTNAME); ?> <?php echo e($Value->MIDDLENAME); ?> <?php echo e($Value->LASTNAME); ?> / <?php echo e($Value->SEX); ?></td>
                                <td ><?php echo e($Value->ADDRESS_UNIT_NO); ?> 
                                    <?php echo e($Value->ADDRESS_PHASE); ?>

                                    <?php echo e($Value->ADDRESS_HOUSE_NO); ?>

                                    <?php echo e($Value->ADDRESS_STREET); ?>

                                    <?php echo e($Value->ADDRESS_SUBDIVISION); ?>

                                    <?php echo e($Value->ADDRESS_BUILDING); ?>

                                </td>
                                <td ><?php echo e($Value->SEX); ?></td>
                                <td ><?php echo e($Value->DATE_OF_BIRTH); ?>, <?php echo e($Value->PLACE_OF_BIRTH); ?></td>
                                <td ><?php echo e($Value->CIVIL_STATUS); ?></td>
                                <td ><?php echo e($Value->OCCUPATION); ?></td>
                                <td ><?php echo e($Value->CITIZENSHIP); ?></td>
                                <td ><?php echo e($Value->ADDRESS_UNIT_NO); ?></td>
                                <td ><?php echo e($Value->ADDRESS_SUBDIVISION); ?></td>
                                <td ><?php echo e($Value->ADDRESS_BUILDING); ?></td>
                                <td>
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                             <select class="form-control " data-style="btn-lime" name="ArrivalReason" id="ArrivalReason">
                                <?php $__currentLoopData = $resident_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option id="<?php echo e($key); ?>"><?php echo e($value); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
...
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/resident/basicinfo.blade.php ENDPATH**/ ?>
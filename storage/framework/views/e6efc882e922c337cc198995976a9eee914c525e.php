      ...
      <table style="font-size: 15px; width: 100%;" border="1" cellpadding="5">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td colspan="3" style=" text-align: center; width:13%"><?php echo e($row->LASTNAME); ?> <?php echo e($row->FIRSTNAME); ?> <?php echo e($row->MIDDLENAME); ?></td>
                <td colspan="3" style=" text-align: center; width:13%"><?php echo e($row->DATE_OF_BIRTH); ?></td>
                <td colspan="3" style=" text-align: center; width:13%"><?php echo e($row->PLACE_OF_BIRTH); ?></td>
                <td colspan="2" style=" text-align: center; width:13%"><?php echo e($row->SEX); ?></td>
                <td colspan="3" style=" text-align: center; width:13%"><?php echo e($row->CIVIL_STATUS); ?></td>
                <td colspan="3" style=" text-align: center; width:13%"><?php echo e($row->OCCUPATION); ?></td>
                <td colspan="3" style=" text-align: center; width:13%"><?php echo e($row->CITIZENSHIP); ?></td>
                <td colspan="3" style=" text-align: center; width:13%"><?php echo e($row->CITIZENSHIP); ?></td>
...
<!--  <label><b>CERTIFICATION</b></label>
        ...
        </p> --><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/listofresidentsprintable.blade.php ENDPATH**/ ?>
    ...
    function loadfilter(fd) {
        return new Promise((resolve,reject) => {
            ...
            var lname, fname, mname, quali, sex, dob, cstatus, occu, wstatus, active_flag, status_name, fullname;
                ...
                $.ajax({
                    url:"<?php echo e(route('ResidentsFilter')); ?>",
                    type:'post',
                    processData:false,
                    contentType:false,
...
<div id="content" class="content">
    ...
    <!-- begin row -->
    <div >
        <form method="POST" action="<?php echo e(route('ResidentFilterPrint')); ?>">
                            ...
                            <table id="data-table-default" class="table table-striped table-bordered display compact" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;"><?php echo e($basicinfo->LASTNAME); ?> <?php echo e($basicinfo->FIRSTNAME); ?> <?php echo e($basicinfo->MIDDLENAME); ?></td>
                                        
                                        <td style="text-align: left;"><?php echo e($basicinfo->SEX); ?></td>
                                        <td style="text-align: left;"><?php echo e($basicinfo->DATE_OF_BIRTH); ?></td>
                                        <td style="text-align: left;"><?php echo e($basicinfo->CIVIL_STATUS); ?></td>
                                        <td style="text-align: left;"><?php echo e($basicinfo->OCCUPATION); ?></td>
                                        <td style="text-align: left;"><?php echo e($basicinfo->WORK_STATUS); ?></td>
...
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/queriesreports/listofresidentsreport.blade.php ENDPATH**/ ?>
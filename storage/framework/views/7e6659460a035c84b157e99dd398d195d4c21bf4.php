<?php $__env->startSection('title', "BitBo | Household Profile"); ?>
...
<?php $__env->startSection('page-js'); ?>
   ...
   var table = $("#data-table-default").DataTable({
                  serverSide: true,
                  processing: true,    
                  ajax:"<?php echo e(route('LoadHousehold')); ?>",
    ...
    <script type="text/javascript">
      function famMembers(id) {
          ...
          location.href = "<?php echo e(asset('')); ?>" + "HouseholdMembers/"+$id;
      }
      ...
      $(document).ready(function() {
        ...
        //   //location.href = "<?php echo e(route('HouseholdProfile')); ?>";
        //   //"<?php echo e(asset('')); ?>"+
        // });
    ...
    async function Update(fd) {
       swal("Data have been successfully updated!", {
          ...
          {
              result = await $.ajax({
                   url:"<?php echo e(route('HouseholdProfileEdit')); ?>",
                   type:'post',
                   processData:false,
                   contentType:false,
                   cache:false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/resident/houseprofile.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', "BitBo | Dashboard"); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="widget widget-stats bg-blue">
                    ...
                    <div class="stats-info">
                        ...
                        <p><?php echo e($get_total_residents); ?></p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="widget widget-stats bg-yellow">
                    ...
                    <div class="stats-info">
                        ...
                        <p><?php echo e($get_total_household); ?></p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="widget widget-stats bg-green">
                    ...
                    <div class="stats-info">
                        ...
                        <p><?php echo e($get_total_businesses); ?></p>
                    </div>
                    <div class="stats-link">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="widget widget-stats  bg-red">
                    ...
                    <div class="stats-info">
                        <h4>Blotter Cases</h4>
                        <p><?php echo e($get_total_blotters); ?></p>
                    </div>
                    <div class="stats-link">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="widget widget-stats  bg-orange">
                    ...
                    <div class="stats-info">
                        <h4>Ordinances</h4>
                        <p><?php echo e($get_total_ordinances); ?></p>
                    </div>
                    <div class="stats-link">
                    <a href="<?php echo e(route('Ordinance')); ?>" >View Ordinances <i class="fa fa-arrow-alt-circle-right"></i></a>
                   </div>
            ...
            "series": [
                {
                    ...
                    "data": [
                         <?php 
                            ...
                            ?>
                            <?php $__currentLoopData = $get_males; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            {
                                "name": "Male",
                                "y": <?php echo e($val->Male); ?>,
                                "drilldown": "Male"
                       ...
                       <?php 
                                ...
                                ->groupBy(db::raw('YEAR(CREATED_AT)'))->get();
                            ?>
                            <?php $__currentLoopData = $get_females; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            {
                                "name": "Female",
                                "y": <?php echo e($val->Female); ?>,
                                "color": colors[2],
                                "drilldown": "Female"
                            },
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="modal-content">
                       ...
                       <script type="text/javascript">
                        ...
                        Highcharts.chart('container-residents', {
                            ...
                            ?>    
                            <?php $__currentLoopData = $get_years_resident; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            {
                                name: 'Year <?php echo e($value->YEARS); ?>',
                                ...
                                data: [
                                    ...
                                    ?>    
                                    <?php echo e($get_count_ofw_residents); ?>,
                                    <?php echo e($get_count_indigenous_residents); ?>, 
                                    <?php echo e($get_count_senior_residents); ?>
                        ...
                        Highcharts.chart('container-residents-employment', {
                            ...
                            <?php $__currentLoopData = $get_years_resident; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            {
                                ...
                                data: [
                                    ...
                                    ?>    
                                    <?php echo e($get_count_employed); ?>,
                                    <?php echo e($get_count_unemployed); ?>, 
                        ...
                        Highcharts.chart('container-residents-fp-nfp', {
                            ...
                            <?php $__currentLoopData = $get_years_resident; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            {
                                ...
                                data: [
                                    ...
                                    ?>    
                                    <?php echo e($get_count_fp); ?>,
                                    <?php echo e($get_count_nfp); ?>, 
                        ...
                        Highcharts.chart('container-build-materials', {
                            ...
                            <?php $__currentLoopData = $get_years_resident; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            {
                                ...
                                data: [
                                    ...
                                    ?>    
                                    <?php echo e($get_count_nipa); ?>,
                                    <?php echo e($get_count_wood); ?>, 
                                    <?php echo e($get_count_concrete); ?>
                        ...
                        Highcharts.chart('container-businesses', {
                            ...
                            xAxis: {
                                ...
                                categories: [
                                    ...
                                    ?>    
                                    <?php $__currentLoopData = $get_business_nature; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    '<?php echo e($value->BUSINESS_NATURE_NAME); ?>',
                            ...
                            <?php $__currentLoopData = $get_years_businesses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...

                            {
                                ...
                                data: [
                                    <?php $__currentLoopData = $get_business_nature; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                    <?php
                                        $get_count_nature_businesses = DB::table('t_business_information')                                                                        
                                                                        ...
                                                                        ->count();
                                    ?>    
                                    <?php echo e($get_count_nature_businesses); ?>,
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ]
                            },
                        ...
                        Highcharts.chart('container-blotters', {
                            ...
                            xAxis: {
                                ...
                                categories: [
                                    ...
                                    ?>    
                                    <?php $__currentLoopData = $get_blotter_subject; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    '<?php echo e($value->BLOTTER_NAME); ?>',
                            ...
                            <?php $__currentLoopData = $get_years_blotter_cases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        

                            {
                                name: 'Year <?php echo e($value->YEAR_CREATED); ?>',

                                data: [
                                    <?php $__currentLoopData = $get_blotter_subject; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                    <?php
                        ...
                        Highcharts.chart('population-by-age', {
                            ...
                            <?php $__currentLoopData = $get_years_resident; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            {
                                ...
                                data: [
                                    ...
                                    ?>    
                                    <?php echo e($get_count_newborn); ?>,
                                    <?php echo e($get_count_infant); ?>, 
                                    <?php echo e($get_count_child); ?>, 
                                    <?php echo e($get_count_Adolescent); ?>, 
                                    <?php echo e($get_count_Elderly); ?>
                        ...
                        Highcharts.chart('population-by-civil-status', {
                            ...
                            <?php $__currentLoopData = $get_years_resident; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            {
                                ...
                                data: [
                                    ...
                                    ?>    
                                    <?php echo e($get_count_single); ?>,
                                    <?php echo e($get_count_married); ?>, 
                                    <?php echo e($get_count_widow); ?>, 
                                    <?php echo e($get_count_divorced); ?>, 
                                    <?php echo e($get_count_annulled); ?>,
                                    <?php echo e($get_count_widower); ?>
...
Highcharts.chart('illness', {
    ...
    series: [
        ...
        data: [
                ...
                <?php echo e(round($get_count_chronic_cough, 2)); ?>
        ...
        data: [
            ...
            <?php echo e(round($get_count_chronic_disease, 2)); ?>
            ...
            Highcharts.chart('blotters', {
                ...
                "series": [
                    {
                        ...
                        "data": [
                            ...
                            ?>
                            <?php $__currentLoopData = $get_years_blotter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            {
                                "name": "<?php echo e($val->YEAR_CREATED); ?>",
                                "y": <?php echo e($val->COUNT_BLOTTER); ?>,
                                "drilldown": "<?php echo e($val->YEAR_CREATED); ?>"
                            },
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                "drilldown": {
                    "series": [
                        ...
                        {
                            "name": "<?php echo e($val->YEAR_CREATED); ?>",
                            "id": "<?php echo e($val->YEAR_CREATED); ?>",
                            "data": [
                                <?php 
                                ...
                                [
                                    "January",
                                    <?php echo e($get_month_jan_blotter); ?>

                                ],
                                [
                                    "February",
                                    <?php echo e($get_month_feb_blotter); ?>

                                ],
                                [
                                    "March",
                                    <?php echo e($get_month_march_blotter); ?>

                                ],
                                [
                                    "April",
                                    <?php echo e($get_month_april_blotter); ?>

                                ],
                                [
                                    "May",
                                    <?php echo e($get_month_may_blotter); ?>

                                ],
                                [
                                    "June",
                                    <?php echo e($get_month_june_blotter); ?>

                                ],
                                [
                                    "July",
                                    <?php echo e($get_month_july_blotter); ?>

                                    
                                ],
                                [
                                    "August",
                                    <?php echo e($get_month_august_blotter); ?>

                                    
                                ],
                                [
                                    "September",
                                    <?php echo e($get_month_september_blotter); ?>

                                    
                                ],
                                [
                                    "October",
                                    <?php echo e($get_month_october_blotter); ?>

                                    
                                ],
                                [
                                    "November",
                                    <?php echo e($get_month_november_blotter); ?>

                                    
                                ],
                                [
                                    "December",
                                    <?php echo e($get_month_december_blotter); ?>
            ...
            "series": [
                {
                    ...
                    "data": [
                         <?php 
                                ...
                                ->groupBy(db::raw('YEAR(CREATED_AT)'))->get();
                            ?>
                            <?php $__currentLoopData = $get_nonregistered_voters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            {
                                "name": "Registered",
                                "y": <?php echo e($val->REGISTERED); ?>,
                       ...
                       <?php 
                            ...
                            {
                                "name": "Non-Registered",
                                "y": <?php echo e($val->NON_REGISTERED); ?>,
                                "color": colors[2]
...
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\home\Documents\EDCEL\BITBO INSTALLER\BITBo\www\resources\views/dashboard.blade.php ENDPATH**/ ?>
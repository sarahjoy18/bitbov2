<?php $__env->startSection('title', "Father's Profile"); ?>
    ...
    <script type="text/javascript">
        ...
        async function Update(fd) {
            swal("Data have been successfully Updated!", {
              ...
              {
                  result = await $.ajax({
                       url:"<?php echo e(route('FathersProfileEdit')); ?>",
                       type:'post',
                       processData:false,
                       contentType:false,
                       cache:false,
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
       ...
       swal("Data have been successfully Added!", {
          ...
          {
              result = await $.ajax({
                   url:"<?php echo e(route('FathersProfileAdd')); ?>",
                   type:'post',
                   processData:false,
                   contentType:false,
                   cache:false,
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            ...
                            <table id="data-table-default" class="table table-striped table-bordered">
                                ...
                                <?php $__currentLoopData = $FatherTable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                               
                                <tr >

                                    <td hidden><?php echo e($profile->FATHERS_ID); ?></td>
                                    ...
                                    <td style="background-color: <?php echo e($profile->ACTIVE_FLAG == 1 ? '#ddefc9' : '#ffcdcc'); ?>"><?php echo e($profile->FATHER_MOTHER_TONGUE); ?></td>
                                    <td style="background-color: <?php echo e($profile->ACTIVE_FLAG == 1 ? '#ddefc9' : '#ffcdcc'); ?>"><?php echo e($profile->FATHER_OTHER_DIALECTS); ?></td>
                                    <td style="background-color: <?php echo e($profile->ACTIVE_FLAG == 1 ? '#ddefc9' : '#ffcdcc'); ?>"><?php echo e($profile->FATHER_EDUCATIONAL_ATTAINMENT); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/resident/fathersprofile.blade.php ENDPATH**/ ?>
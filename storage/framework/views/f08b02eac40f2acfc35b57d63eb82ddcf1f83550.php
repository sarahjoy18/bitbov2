<?php $__env->startSection('title', "Barangay Setup"); ?>
        ...
        else
        {
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    setTimeout(function(){ 
                        $.ajax({
                            url:"<?php echo e(route('EditBarangay')); ?>",
                            type:'post',
                            processData:false,
                            contentType:false,
                            cache:false,
        ...
        if (willDelete) {
            ...
            setTimeout(function(){ 
                $.ajax({
                    ...
                    data:{'_token':'<?php echo e(csrf_token()); ?>','BarangayIDTxt':barid},
                    success:function()
                    {
...
<div id="content" class="content">
                    ...
                    <table id="data-table-default" class="table table-striped table-bordered">
                        <thead>
                            ...
                            <tbody>
                                ...
                                <tr >
                                    <td hidden><?php echo e($value->BARANGAY_ID); ?></td>
                                    <td><?php echo e($value->BARANGAY_NAME); ?></td>
                                    <td hidden><?php echo e($value->BARANGAY_SEAL); ?></td>

                                    <td>
                                        <embed src="<?php echo e(asset('upload/barangay/'.$value->BARANGAY_SEAL)); ?>" width="50" height="50"/>
                                        </td>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/setup/barangaysetup.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <link rel='shortcut icon' type='image/x-icon' href="<?php echo e(asset('assets/img/logo/ico/BPIS_Logo_dark.ico')); ?>" />
    <!-- ================== END BASE CSS STYLE ================== -->
...
<div class="login-cover">
    <div class="login-cover-image" style="background-image: url(<?php echo e(asset('assets/img/login-bg/login-bg-14.jpg)')); ?>" data-id="login-cover-image"></div>
...
<div id="page-container" class="fade"  >
    ...
    <div class="login login-v2" data-pageload-addclass="animated fadeIn" style="overflow:hidden; margin-top:100px;">
        ...
        <div class="login-header">
            <div class="brand"> <img src="<?php echo e(asset('assets/img/logo/BitBo_Logo.png')); ?>" style="object-fit: cover;" width="300" height="105" />
                <div class="icon">
        ...
        <div class="login-content" >
         ...
         <?php echo csrf_field(); ?>
                ...
                <div class="m-t-20">
                    Forgot password? Click <a href="<?php echo e(route('ResetPassword')); ?>">here</a> to reset.
                </div>
            </form>
        </div>
        <!-- end login-content -->
...
<!-- ================== BEGIN PAGE LEVEL JS ================== -->
<script src="<?php echo e(asset('assets/js/demo/login-v2.demo.min.js')); ?>"></script>
<!-- ================== END PAGE LEVEL JS ================== -->
        ...
        {   e.preventDefault();
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    {
                        location.replace ('<?php echo e(route("UserAccounts")); ?>'); 
                    }else{
...
<?php /**PATH C:\Users\home\Documents\EDCEL\BITBO INSTALLER\BITBo\www\resources\views/login/login.blade.php ENDPATH**/ ?>
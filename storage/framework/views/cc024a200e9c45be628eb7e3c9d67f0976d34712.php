	...
	<div class="panel panel-inverse">
		...
		<div class="panel-body">
			<table id="tbl_business_lst" class="table table-striped table-bordered">
				...
				<tbody>
					<?php $__currentLoopData = $approved_business; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr class="gradeC" id="<?php echo e($row->BUSINESS_ID); ?>">
						<td><?php echo e($row->BUSINESS_OR_NUMBER); ?></td>
						<td><?php echo e($row->BUSINESS_NAME); ?></td>
						<td><?php echo e($row->BUSINESS_NATURE_NAME); ?></td>
						...
						<td>
							...
							<h6>Gross Receipt: ₱<?php echo e($row->GROSS_RECEIPT_TOTAL); ?></h6>
						...
						<td hidden> <?php echo e($row->BUSINESS_AREA); ?></td>
						<td hidden><?php echo e($row->GROSS_RECEIPTS_ESSENTIAL); ?></td>
						<td hidden><?php echo e($row->GROSS_RECEIPTS_NON_ESSENTIAL); ?></td>
					</tr>
				...
				<div class="modal-body">
						...
						<form>
							...
							<div id="divBusinessPermit_message">
								<br>
								<div class="col-md-10" >
									<h4> The gross receipt sales is less than ₱30,000. Request for Business Permit <a href="<?php echo e(route('RequestPermit')); ?>">here</a></h4>
							...
							<div class="col-md-10" id="divClearanceBusiness">
								...
								<div class="form-group m-b-10" hidden>
									...
									<select class="form-control" id="sel_business_nature_b" data-parsley-required="true">
										...
										<?php $__currentLoopData = $business_nature; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option id="<?php echo e($row->BUSINESS_NATURE_ID); ?>"><?php echo e($row->BUSINESS_NATURE_NAME); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
	...
	$('#btnRequest').on('click', function(){
		...
		$.ajax({
			url : "<?php echo e(route('CRUDRequestClearance')); ?>",
			method : 'POST',
			data : data,
...
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/permit_certification_clearance/clearance.blade.php ENDPATH**/ ?>
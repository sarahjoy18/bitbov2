...
<?php $__env->startSection('title', "Business Category Setup"); ?>
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $__currentLoopData = $displaydata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr >
                                <td hidden><?php echo e($value->BUSINESS_NATURE_ID); ?></td>
                                <td><?php echo e($value->BUSINESS_NATURE_NAME); ?></td>
                                <td><?php echo e($value->BUSINESS_NATURE_DESCRIPTION); ?></td>
                                <td>
                        ...
                        <div class="modal fade" id="UpdateModal">
                            <div class="modal-dialog" style="max-width: 30%">
                                <form id="EditForm" method="POST" action="<?php echo e(route('BusinessCategoryEdit')); ?>">
                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="modal fade" id="AddModal">
                            <div class="modal-dialog" style="max-width: 30%">
                                <form id="AddForm" method="POST" action="<?php echo e(route('BusinessCategory')); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/administration/businesscat.blade.php ENDPATH**/ ?>
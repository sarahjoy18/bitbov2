    ...
    function loadfilter(fd) {
        return new Promise((resolve,reject) => {
            ...
            var bcode, bsub, cdate, cname, idate, stat;
                ...
                $.ajax({
                    url:"<?php echo e(route('ListofBlottersFilterPrint')); ?>",
                    type:'post',
                    processData:false,
                    contentType:false,
...
<div id="content" class="content">
    ...
    <!-- begin row -->
    <div >
        <form method="POST" action="<?php echo e(route('ListofBlottersPrint')); ?>" enctype="multipart/form-data">
                         ...
                         <div id="LoadTable">
                            <table id="data-table-default" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $DisplayTable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blotter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        
                                        <td style="text-align: left; "><?php echo e($blotter->blotter_code); ?></td>
                                        <td style="text-align: left; "><?php echo e($blotter->blotter_subject); ?></td>
                                        <td style="text-align: left; "><?php echo e($blotter->complaint_date); ?></td>
                                        <td style="text-align: left; "><?php echo e($blotter->complaint_name); ?></td>
                                        <td style="text-align: left; "><?php echo e($blotter->incident_date); ?></td>
                                        <td style="text-align: left; "><?php echo e($blotter->status); ?></td>
                                    </tr>
...
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/queriesreports/listofblotters.blade.php ENDPATH**/ ?>
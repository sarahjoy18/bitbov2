   ...
   var table = $("#data-table-default").DataTable({
    ...
    <script type="text/javascript">
      function famMembers(id) {
          ...
          location.href = "<?php echo e(asset('')); ?>" + "ViewRbi/"+$id;
      }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/queriesreports/hh_list.blade.php ENDPATH**/ ?>
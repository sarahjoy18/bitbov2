	...
	<div class="tab-content">
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					<table id="tbl_resident_lst_1" class="table table-striped table-bordered">
						...
						<tbody>
							<?php $__currentLoopData = $newborn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr class="gradeC" id="<?php echo e($row->RESIDENT_ID); ?>">
								<td><?php echo e($row->FIRSTNAME); ?> <?php echo e($row->MIDDLENAME); ?> <?php echo e($row->LASTNAME); ?> </td>
								<td><?php echo e($row->ADDRESS_UNIT_NO); ?> <?php echo e($row->ADDRESS_PHASE); ?> <?php echo e($row->ADDRESS_BLOCK_NO); ?> <?php echo e($row->ADDRESS_HOUSE_NO); ?> <?php echo e($row->ADDRESS_STREET); ?> <?php echo e($row->ADDRESS_SUBDIVISION); ?> <?php echo e($row->ADDRESS_BUILDING); ?></td>
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					<table id="tbl_resident_lst_2" class="table table-striped table-bordered">
						...
						<tbody>
							<?php $__currentLoopData = $nonresident; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr class="gradeC" id="<?php echo e($row->NONRESIDENT_ID); ?>">
								<td><?php echo e($row->FIRST_NAME); ?> <?php echo e($row->MIDDLE_NAME); ?> <?php echo e($row->LAST_NAME); ?> </td>
								<td></td>
		...
		<div class="tab-pane fade " id="nav-pills-tab-3">
			<div class="panel panel-inverse">
				...
				<br>
				<div class="col-md-10">
					<h4>Click <a href="<?php echo e(route('ExportNewborn')); ?>">here</a>  to redownload file</h4>
				</div>
			</div> 
		</div>
...
<script>
	...
	$('#btnExport').on('click', function(){
		...
		.then((willDelete) => {
			if (willDelete) {
				...
				window.location.href = "<?php echo e(route('ExportNewborn')); ?>";
			} else {
				Cancelled();
			}
		});
	...
	$('#tbl_resident_lst_1').on('click', '#btnAddNewborn', function(){
		...
		$.ajax({
			url : "<?php echo e(route('SpecificNewborn')); ?>",
			method : 'POST',
	...
	$('#modal-newBornRecord').on('click', '#btnAddNewbornRecord', function(){
		...
		$.ajax({
			url : "<?php echo e(route('CRUDNewborn')); ?>",
			method : 'POST',
			data : data,
			success : function(response) {
				swal({
...
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/healthservices/newborn.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', "Blotter"); ?>
                ...
                swal({
                    ...
                    .then((willResolve) => {
                        if (willResolve) {
                            ...
                            $.ajax({
                                    url:"<?php echo e(route('ResolvedBlotter')); ?>",
                                    type:'POST',
                                    processData:false,
                                    contentType:false,
                                    cache:false,
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        ...
                        <table id="data-table-default" class="table table-striped table-bordered">
                            ...
                            <tbody>
                        <?php $__currentLoopData = $dispblotter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blotter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <tr >
                                <td hidden><?php echo e($blotter->blotter_id); ?></td>
                                <td><?php echo e($blotter->blotter_code); ?></td>
                                <td><?php echo e($blotter->complaint_date); ?></td>
                                <td><?php echo e($blotter->complaint_name); ?></td>
                                <?php if($blotter->respondent == ""): ?>
                                <td>Unidentified</td>
                                <?php else: ?>
                                <td><?php echo e($blotter->respondent); ?></td>
                                <?php endif; ?>
                                <td><?php echo e($blotter->blotter_subject); ?></td>
                                <td><?php echo e($blotter->incident_date); ?></td>
                                <td hidden><?php echo e($blotter->incident_area); ?></td>
                                <td hidden><?php echo e($blotter->complaint_statement); ?></td>
                                <td hidden><?php echo e($blotter->resolution); ?></td>
                                <td hidden><?php echo e($blotter->status); ?></td>
                                <?php if($blotter->NO_OF_PATAWAG == 2): ?>
                                <td style="background-color: #fff4b2"><?php echo e($blotter->NO_OF_PATAWAG); ?></td>
                                <?php elseif($blotter->NO_OF_PATAWAG == 3): ?>
                                <td style="background-color: #ffcdcb" class="alert-danger"><?php echo e($blotter->NO_OF_PATAWAG); ?></td>
                                <?php else: ?>
                                <td ><?php echo e($blotter->NO_OF_PATAWAG); ?></td>
                                <?php endif; ?>
                                <td>
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        ...
                        <table id="data-table-default1" class="table table-striped table-bordered">
                            ...
                            <tbody>
                        <?php $__currentLoopData = $resolvedBlotter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rblotter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <tr >
                                <td hidden><?php echo e($rblotter->blotter_id); ?></td>
                                <td><?php echo e($rblotter->blotter_code); ?></td>
                                <td hidden><?php echo e($rblotter->complaint_date); ?></td>
                                <td><?php echo e($rblotter->complaint_name); ?></td>
                                <?php if($blotter->respondent == ""): ?>
                                <td>Unidentified</td>                                
                                <?php else: ?>
                                <td><?php echo e($blotter->respondent); ?> </td>
                                <?php endif; ?>
                                <td><?php echo e($rblotter->blotter_subject); ?></td>
                                <td><?php echo e($rblotter->incident_date); ?></td>
                                <td><?php echo e($rblotter->closed_date); ?></td>
                                <td hidden><?php echo e($rblotter->incident_area); ?></td>
                                <td hidden><?php echo e($rblotter->complaint_statement); ?></td>
                                <td><?php echo e($rblotter->resolution); ?></td>
                                <td hidden><?php echo e($rblotter->status); ?></td>
                                <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bitbo_installer\www\resources\views/cases/blotter.blade.php ENDPATH**/ ?>
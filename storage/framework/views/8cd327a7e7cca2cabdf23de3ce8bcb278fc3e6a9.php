...
<?php $__env->startSection('title', "Blotter Subjects Setup"); ?>
                ...
                <div class="panel-body">
                    ...
                    <table id="data-table-default" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td hidden><?php echo e($value->BLOTTER_SUBJECT_ID); ?></td>
                                <td><?php echo e($value->BLOTTER_NAME); ?></td>
                                <td>
                    ...
                    <div class="modal fade" id="UpdateModal">
                        <div class="modal-dialog" style="max-width: 30%">
                            <form id="EditForm" method="POST" action="<?php echo e(route('BlotterSubjectsEdit')); ?>">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="modal fade" id="AddModal">
                        <div class="modal-dialog" style="max-width: 30%">
                            <form id="AddForm" method="POST" action="<?php echo e(route('BlotterSubjectsAdd')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="modal-content">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/administration/blottersubj.blade.php ENDPATH**/ ?>
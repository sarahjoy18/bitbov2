	...
	<div class="tab-content">	
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					<table id="tbl_resident_lst" class="table table-striped table-bordered">
						...
						<tbody>
							<?php $__currentLoopData = $child_resident; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr class="gradeC" id="<?php echo e($row->CHILD_ID); ?>">
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					<table id="tbl_child_lst" class="table table-striped table-bordered">
						...
						<tbody>
							<?php $__currentLoopData = $child_nonresident; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr class="gradeC" id="<?php echo e($row->CHILD_ID); ?>">
		...
		<div class="tab-pane fade " id="nav-pills-tab-3">
			<div class="panel panel-inverse">
				...
				<br>
				<div class="col-md-10">
					<h4>Click <a href="<?php echo e(route('ChildExport')); ?>">here</a>  to redownload file</h4>
				</div>
			</div> 
		</div>
...
<script>
		...
		//swal
		   	...
		   	.then((willDelete) => {
	            if (willDelete) {
	              ...
	              window.location.href = "<?php echo e(route('ChildExport')); ?>";
	            } else {
	               Cancelled();
	            }
        });
	...
	$('#tbl_resident_lst').on('click', '#btnAddChild', function(){
		...
		$.ajax({
			url : "<?php echo e(route('SpecificChild')); ?>",
			method : 'POST',
			data : data,
	...
	$('#modal-Child').on('click', '#btnChild', function(){
		...
		$.ajax({
			url : "<?php echo e(route('CRUDChild')); ?>",
			method : 'POST',
			data : data,
			success : function(response) {
				swal({
	...
	<script src="<?php echo e(asset('assets/plugins/bootstrap-sweetalert/sweetalert.min.js')); ?>"></script>
	<?php $__env->stopSection(); ?>
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/healthservices/child.blade.php ENDPATH**/ ?>
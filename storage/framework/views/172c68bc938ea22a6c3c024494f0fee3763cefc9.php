	...
	<div class="tab-content">
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					...
					<table id="tbl_resident_lst_1" class="table table-striped table-bordered">
						...
						<tbody>
							<?php $__currentLoopData = $infant_resident; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr class="gradeC" id="<?php echo e($row->INFANT_ID); ?>">
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					<table id="tbl_resident_lst_2" class="table table-striped table-bordered">
						...
						<tbody>
							<?php $__currentLoopData = $infant_nonresident; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr class="gradeC" id="<?php echo e($row->INFANT_ID); ?>">
		...
		<div class="tab-pane fade " id="nav-pills-tab-3">
			<div class="panel panel-inverse">
				...
				<br>
				<div class="col-md-10">
					<h4>Click <a href="<?php echo e(route('InfantExport')); ?>">here</a>  to redownload file</h4>
				</div>
			</div> 
		</div>
...
<script>
	...
	$('#tbl_resident_lst_1').on('click', '#btnAddInfant', function(){
		...
		$.ajax({
			url : "<?php echo e(route('SpecificInfant')); ?>",
			method : 'POST',
	...
	$('#modal-Infant').on('click', '#btnInfant', function(){
		...
		$.ajax({
			url : "<?php echo e(route('CRUDInfant')); ?>",
			method : 'POST',
			data : data,
			success : function(response) {
				swal({
	...
	$('#btnExport').on('click', function(){
		...
		.then((willDelete) => {
			if (willDelete) {
				...
				window.location.href = "<?php echo e(route('InfantExport')); ?>";
			} else {
				Cancelled();
			}
		});
...
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/healthservices/infants.blade.php ENDPATH**/ ?>
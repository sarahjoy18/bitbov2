							...
							<tr class="gradeC" id="	">
								...
								<td>
									<button type="button" class="btn btn-yellow" id="btnPrintClearance"  data-toggle="modal">
										<i class="fa fa-file-alt"></i> Print <?php echo e($row->REQUESTED_PAPER_TYPE); ?>
...
<?php echo $__env->make('global.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITBO_INSTALLER\4. BITBo\www\resources\views/permit_certification_clearance/issuance.blade.php ENDPATH**/ ?>
...
IF header_id > 0 THEN
		SELECT TB.FAMILY_HEADER_ID
			, CONCAT(COALESCE(T.LASTNAME,''), ' ', COALESCE(T.FIRSTNAME,''), ' ', COALESCE(T.MIDDLENAME,'')) AS FULLNAME
			, LASTNAME
			, FIRSTNAME
			, MIDDLENAME
			, QUALIFIER

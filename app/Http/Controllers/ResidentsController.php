        ...
        for($i = 0 ;  $i < count($multi_rbi_first_name) ; $i++)
        {
            ...
            ->INSERTGETID(
                [
                    ...
                    'ADDRESS_HOUSE_NO' => $multi_rbi_houseno[$i],
                    'ADDRESS_STREET_NO' => $multi_rbi_hstreet_no[$i],
                    'ADDRESS_STREET' => $multi_rbi_hstreet[$i],
                    //'ADDRESS_PHASE' => $multi_rbi_hphase[0],
                    'ADDRESS_BUILDING' => $multi_rbi_hbuilding[$i],
                    'ADDRESS_UNIT_NO' => $multi_rbi_hunitno[$i],
                    'ADDRESS_SUBDIVISION' => $multi_rbi_hsubdivision[$i],

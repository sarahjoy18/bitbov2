                        ...
                        <tbody>
                           <!--  
                            ...
                            <tr >
                                ...
                                <td >{{$Value->RELATION_TO_HOUSEHOLD_HEAD}}</td>
                                <td ></td>
                                <td >{{$Value->ADDRESS_HOUSE_NO}}</td>
                                <td >{{$Value->ADDRESS_STREET}}</td>
                                <td >{{$Value->ADDRESS_STREET}}</td>
                                <td >{{$Value->FIRSTNAME}} {{$Value->MIDDLENAME}} {{$Value->LASTNAME}} / {{$Value->SEX}}</td>
                                <td >{{$Value->ADDRESS_UNIT_NO}} 
                                    {{$Value->ADDRESS_PHASE}}
                                    {{$Value->ADDRESS_HOUSE_NO}}
                                    {{$Value->ADDRESS_STREET}}
                                    {{$Value->ADDRESS_SUBDIVISION}}
                                    {{$Value->ADDRESS_BUILDING}}
                                </td>
                                <td >{{$Value->SEX}}</td>
                                <td >{{$Value->DATE_OF_BIRTH}}, {{$Value->PLACE_OF_BIRTH}}</td>
                                <td >{{$Value->CIVIL_STATUS}}</td>
                                <td >{{$Value->OCCUPATION}}</td>
                                <td >{{$Value->CITIZENSHIP}}</td>
                                <td >{{$Value->ADDRESS_UNIT_NO}}</td>
                                <td >{{$Value->ADDRESS_SUBDIVISION}}</td>
                                <td >{{$Value->ADDRESS_BUILDING}}</td>
                                <td>
